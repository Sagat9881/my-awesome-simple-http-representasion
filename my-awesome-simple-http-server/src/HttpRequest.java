...
public class HttpRequest {
    ...
    public HttpRequest(String message) {
        ...
        String bodyLengths = this.headers.get("Content-Length");
        int lengths = bodyLengths != null ? Integer.parseInt(bodyLengths) : 0;

        this.body = parts.length > 1 ? parts[1].trim().substring(0, lengths) : "";
    }
